...
td3_lr_decay = 0.995         # 学习率衰减系数
td3_epsilon_final = 0.01  # 最终epsilon值
td3_epsilon_decay = 9000  # epsilon衰减步数
...
parser_td3.add_argument('--lr_decay', type=float, default=td3_lr_decay)
parser_td3.add_argument('--epsilon_final', type=float, default=td3_epsilon_final)
parser_td3.add_argument('--epsilon_decay', type=float, default=td3_epsilon_decay)
